...
def add_gain_indicators(stock_data,stock_name,stock_obj):
    add_data_initialAmount(stock_data,stock_name,stock_obj);
    add_data_finalAmount(stock_data,stock_name,stock_obj);
    add_data_gainAmount(stock_data,stock_name,stock_obj);
    add_data_gainAmountPercentage(stock_data,stock_name,stock_obj);
